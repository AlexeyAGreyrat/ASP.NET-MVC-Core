...
namespace Lesson8.Controllers
{
    public class OfficesController : Controller
    {
        ...
        public OfficesController(OfficeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseWork,location,Type,Time")] Office office)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseWork,location,Type,Time")] Office office)
        {
            if (id != office.Id)
            {
                return NotFound();
